...
echo -n "Getting Node Source..."; curl -sL https://deb.nodesource.com/setup_8.x | sudo bash -  > /dev/null; echo "Done.";
...
sleep 2
echo "~~~~~~~~~~~~~~~~~~~~~~~~~~"
echo "To Start With Ogar Installation Execute ./create.sh gamefolder 89 98"
echo "~~~~~~~~~~~-.-~~~~~~~~~~~~"
sleep 1
